...
void display(void)
{
    float whiteDiffuse[] = { 0.4, 0.4, 0.4, 1.0 };
    ...
    float whiteAmbient[] = { 0.5, 0.5, 0.5, 1.0 };
	float light0[] = { 1.0, 1.0, 1.0, 0.0 };
    float light1[] = { 0.0, 0.0, 0.0, 1.0 };
    float spotDirection[] = { 0.0, -1.0, -0.5 };
    int i, j;
    float x0, y0;
    float emission[]={1.,0.2,0.2};
...
{
    float  diffuse0[] = { 1.0, 0.5, 0.5, 1.0 };
    float  specular0[] = { 0.1, 0.1, 0.1, 1.0 };
    float  diffuse1[] = { -1.0, 0.0, 0.0, 1.0 };
    float  specular1[] = { -1.0, 0.0, 0.0, 1.0 };
