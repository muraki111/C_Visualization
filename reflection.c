...
float nearw = 1.0, farw = 30.0, fovy = 75.0;
...
void display(void)
{
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0.35,0.0); glVertex3f(-15,-15,-15);
		glTexCoord2f(0.35,0.5); glVertex3f(-15,15,-15);
		glTexCoord2f(0.0,0.5); glVertex3f(15,15,-15);
		glTexCoord2f(0.0,0.0); glVertex3f(15,-15,-15);
	glEnd();

	glBegin(GL_QUADS);
		glTexCoord2f(0.95,0.55); glVertex3f(-15,-15,15);
		glTexCoord2f(0.95,0.95); glVertex3f(-15,15,15);
		glTexCoord2f(0.72,0.95); glVertex3f(15,15,15);
		glTexCoord2f(0.72,0.55); glVertex3f(15,-15,15);
	glEnd();

	glBegin(GL_QUADS);
		glTexCoord2f(0.4,0.0); glVertex3f(-15,-15,-15);
		glTexCoord2f(0.7,0.0); glVertex3f(-15,-15,15);
		glTexCoord2f(0.7,0.5); glVertex3f(15,-15,15);
		glTexCoord2f(0.4,0.5); glVertex3f(15,-15,-15);
	glEnd();

	glBegin(GL_QUADS);
		glTexCoord2f(0.4,1.0); glVertex3f(-15,15,-15);
		glTexCoord2f(0.4,0.5); glVertex3f(-15,15,15);
		glTexCoord2f(0.7,0.5); glVertex3f(15,15,15);
		glTexCoord2f(0.7,1.0); glVertex3f(15,15,-15);
	glEnd();

	glBegin(GL_QUADS);
		glTexCoord2f(1.0,0.0); glVertex3f(15,-15,-15);
		glTexCoord2f(1.0,0.5); glVertex3f(15,15,-15);
		glTexCoord2f(0.7,0.5); glVertex3f(15,15,15);
		glTexCoord2f(0.7,0.0); glVertex3f(15,-15,15);
	glEnd();
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0.35,0.5); glVertex3f(-15,-15,-15);
		glTexCoord2f(0.35,1.0); glVertex3f(-15,15,-15);
		glTexCoord2f(0.0,1.0); glVertex3f(-15,15,15);
		glTexCoord2f(0.0,0.5); glVertex3f(-15,-15,15);
	glEnd();
...
//	glTexImage2D(GL_TEXTURE_2D, 0, 4,imageHeightb, imageWidthb,0, GL_RGBA, GL_UNSIGNED_BYTE, *image3);
...
int imageHeightb, imageWidthb;
	...
	glBindTexture(GL_TEXTURE_CUBE_MAP,4);
	glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, 0, GL_RGBA, 128,128,0,GL_RGBA, GL_UNSIGNED_BYTE, *image3);
	glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, GL_RGBA, 128,128,0,GL_RGBA, GL_UNSIGNED_BYTE, *image3);
	glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, GL_RGBA, 128,128,0,GL_RGBA, GL_UNSIGNED_BYTE, *image3);
	glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, GL_RGBA, 128,128,0,GL_RGBA, GL_UNSIGNED_BYTE, *image3);
	glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 0, GL_RGBA, 128,128,0,GL_RGBA, GL_UNSIGNED_BYTE, *image3);
	glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 0, GL_RGBA, 128,128,0,GL_RGBA, GL_UNSIGNED_BYTE, *image3);
