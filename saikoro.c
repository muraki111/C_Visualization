...
void display(void)
{
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0.4,0.0); glVertex3f(-0.5,-0.5,-0.5);
		glTexCoord2f(0.7,0.0); glVertex3f(-0.5,-0.5,0.5);
		glTexCoord2f(0.7,0.5); glVertex3f(0.5,-0.5,0.5);
		glTexCoord2f(0.4,0.5); glVertex3f(0.5,-0.5,-0.5);
	glEnd();
	...
	glBegin(GL_QUADS);
		...
		glTexCoord2f(0.7,0.5); glVertex3f(-0.5,0.5,0.5);
		glTexCoord2f(0.7,1.0); glVertex3f(0.5,0.5,0.5);
		glTexCoord2f(0.4,1.0); glVertex3f(0.5,0.5,-0.5);
	glEnd();
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0.0,0.5); glVertex3f(-0.5,-0.5,-0.5);
		glTexCoord2f(0.35,0.5); glVertex3f(-0.5,0.5,-0.5);
		glTexCoord2f(0.35,1.0); glVertex3f(-0.5,0.5,0.5);
...
int imageHeightb, imageWidthb;
	...
	if(!ReadBitMapData("saikoro.bmp",&imageWidthb,&imageHeightb,image3)){	
		printf("Error! \n");
		exit(0);
	}
